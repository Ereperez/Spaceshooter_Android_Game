...
public abstract class Entity {
    ...
    float _velX = 0;
    float _velY = 0;
    static final int STAGE_WIDTH = GameSettings.STAGE_WIDTH;
    static final int STAGE_HEIGHT = GameSettings.STAGE_HEIGHT;
    static final int ENEMY_SPAWN_OFFSET = GameSettings.ENEMY_SPAWN_OFFSET;
